...
import imagem1 from '/images/912df1fd4870dd78610575c37cc32853.png';
import imagem2 from '../../public/images/146c4312d320fa52b8d4758956ec4831.png';
  ...
  return (
    <div style={{background:"black",color:"white",minHeight:"100vh"}}>
        <div style={{display : "flex",justifyContent : "center"}} >
            <img style={{paddingTop:"1%"}} src={imagem2}
            width={"40%"}  alt="" />
        </div>
