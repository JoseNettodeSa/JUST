...
import imagem2 from "../../public/images/23218824823c957ecc4c35cc639c036b.png";
import imagem3 from "../../public/images/trabalhista.png";
import imagem4 from "../../public/images/penal.png";
import imagem5 from "../../public/images/Captura de tela 2024-11-26 084116.png";
import imagem6 from "../../public/images/renomear1.png";
import imagem7 from "../../public/images/renomear2.png";
import imagem8 from "../../public/images/renomear3.png";
  ...
  return (
    <div style={{background:"black",color:"white",minHeight:"100vh"}}>
        <div style={{display : "flex",justifyContent : "center"}} >
            <img style={{paddingTop:"1%"}} src={imagem1}
            width={"40%"}  alt="" />
        </div>
        ...
        <div id="te">
            ...
            <div style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",paddingBottom:"10px"}}>
                <img src={imagem3} width={600} alt="" /><br />
            ...
            {id == "Penal" &&
            <div style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",paddingBottom:"10px"}}>
                <img src={imagem4} width={600} alt="" /><br />
                <p><br />
            ...
            <div style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
                <img src={imagem5}width={600} alt="" /><br />
            ...
            {id == "Civil" &&
            <div style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",paddingBottom:"10px"}}>
                <img src={imagem6} width={600} alt="" /><br />
                <p>
                ...
                <img src={imagem7} width={600} alt="" /><br />
                ...
                <img src={imagem8} width={600} alt="" /><br />
